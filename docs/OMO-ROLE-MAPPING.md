...
| **librarian** | Librarian (librarian.d.ts) | **MIRIP** — OMO Librarian = "docs/code search" (dari README). agy-bridge Librarian = codebase archaeologist + git history. Fokus sama: research + git. |
